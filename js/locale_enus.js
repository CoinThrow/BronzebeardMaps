...
var l_guide_categories_icons = [
    'inv_misc_paperbundle03a', // 0
    'newplayerhelp_newcomer', // 1
    'achievement_boss_cthun', // 2
    'inv_misc_paperbundle04c', // 3
    'achievement_bg_most_damage_killingblow_dieleast', // 4
    'achievement_quests_completed_07', // 5
    'garrison_building_tradingpost', // 6
    'warrior_skullbanner', // 7
    'achievement_bg_killflagcarriers_grabflag_capit', // 8
];


var g_build_stats_text = {
    "STAT_INTELLECT": 'Primary stat: Intellect',
    "STAT_STRENGTH": 'Primary stat: Strength',
    "STAT_AGILITY": 'Primary stat: Agility',
    "STAT_SPIRIT": 'Primary stat: Spirit',
}

var g_build_stats_icons = {
    "STAT_INTELLECT": 'spell_holy_arcaneintellect',
    "STAT_STRENGTH": 'spell_holy_sealofwrath',
    "STAT_AGILITY": 'ability_rogue_sprint',
    "STAT_SPIRIT": 'spell_holy_sealofwisdom',
}

var g_build_roles_text = {
    "PLAYER_ROLE_DAMAGE": 'Damage Dealer',
    "PLAYER_ROLE_TANK": 'Tank',
    "PLAYER_ROLE_HEALER": 'Healer',
}

var css_build_roles_icon_classes = {
    "PLAYER_ROLE_DAMAGE": 'icon-damagerole',
    "PLAYER_ROLE_TANK": 'icon-tankrole',
    "PLAYER_ROLE_HEALER": 'icon-healerrole',
}

var build_roles_text = {
    "PLAYER_ROLE_DAMAGE": 'Damage Dealer',
    "PLAYER_ROLE_TANK": 'Tank',
    "PLAYER_ROLE_HEALER": 'Healer',
}

var css_build_roles_backdrop_classes = {
    "PLAYER_ROLE_DAMAGE": 'backdrop-damage',
    "PLAYER_ROLE_TANK": 'backdrop-tank',
    "PLAYER_ROLE_HEALER": 'backdrop-healer',
}

var g_build_difficulty_text = {
    "BUILD_DIFFICULTY_RATING_EASY": 'Easy',
    "BUILD_DIFFICULTY_RATING_NORMAL": 'Normal',
    "BUILD_DIFFICULTY_RATING_HARD": 'Hard',
    "BUILD_DIFFICULTY_RATING_VERY_HARD": 'Very Hard',
    "BUILD_DIFFICULTY_RATING_IMPOSSIBLE": 'Impossible', //pretty sure this is unused but whatever
}

var g_build_difficulty_order = {
    "BUILD_DIFFICULTY_RATING_EASY": 1,
    "BUILD_DIFFICULTY_RATING_NORMAL": 2,
    "BUILD_DIFFICULTY_RATING_HARD": 3,
    "BUILD_DIFFICULTY_RATING_VERY_HARD": 4,
    "BUILD_DIFFICULTY_RATING_IMPOSSIBLE": 5,
}

var g_build_difficulty_colors = {
    "BUILD_DIFFICULTY_RATING_EASY": '#44d031',
    "BUILD_DIFFICULTY_RATING_NORMAL": '#ffc400',
    "BUILD_DIFFICULTY_RATING_HARD": '#ff8400',
    "BUILD_DIFFICULTY_RATING_VERY_HARD": '#d53939',
    "BUILD_DIFFICULTY_RATING_IMPOSSIBLE": '#ff0000',
}


var wa_categories_icons = [
    'inv_misc_paperbundle03a', // 0
    'ability_racial_arcaneaffinity', // 1
    'achievement_boss_generaldrakkisath', // 2
    'spell_misc_warsongfocus', // 3
    'inv_fabric_linen_02', // 4
    'trade_engineering', // 5
    'inv_heartofazeroth', // 6
    'inv_misc_build_masters_trophy', // 7
];
...
var mn_classes = [
    [, "Classes"],
    [6, "Death Knight", , , { className: "c6", tinyIcon: "classicon_deathknight" }],
    [11, "Druid", , , { className: "c11", tinyIcon: "classicon_druid" }],
    [3, "Hunter", , , { className: "c3", tinyIcon: "classicon_hunter" }],
    [8, "Mage", , , { className: "c8", tinyIcon: "classicon_mage" }],
    [2, "Paladin", , , { className: "c2", tinyIcon: "classicon_paladin" }],
    [5, "Priest", , , { className: "c5", tinyIcon: "classicon_priest" }],
    [4, "Rogue", , , { className: "c4", tinyIcon: "classicon_rogue" }],
    [7, "Shaman", , , { className: "c7", tinyIcon: "classicon_shaman" }],
    [9, "Warlock", , , { className: "c9", tinyIcon: "classicon_warlock" }],
    [1, "Warrior", , , { className: "c1", tinyIcon: "classicon_warrior" }],
    [10, "Hero", , , { className: "c10", tinyIcon: "classicon_hero" }],
    [, "Conquest of Azeroth"],
    [12, "Barbarian", , , { className: "c12", tinyIcon: "classicon_barbarian" }],
    [13, "Witch Doctor", , , { className: "c13", tinyIcon: "classicon_witchdoctor" }],
    [14, "Felsworn", , , { className: "c14", tinyIcon: "classicon_demonhunter" }],
    [15, "Witch Hunter", , , { className: "c15", tinyIcon: "classicon_witchhunter" }],
    [16, "Stormbringer", , , { className: "c16", tinyIcon: "classicon_stormbringer" }],
    [17, "Knight of Xoroth", , , { className: "c17", tinyIcon: "classicon_fleshwarden" }],
    [18, "Guardian", , , { className: "c18", tinyIcon: "classicon_guardian" }],
    [19, "Templar", , , { className: "c19", tinyIcon: "classicon_monk" }],
    [20, "Bloodmage", , , { className: "c20", tinyIcon: "classicon_sonofarugal" }],
    [21, "Ranger", , , { className: "c21", tinyIcon: "classicon_ranger" }],
    [22, "Chronomancer", , , { className: "c22", tinyIcon: "classicon_chronomancer" }],
    [23, "Necromancer", , , { className: "c23", tinyIcon: "classicon_necromancer" }],
    [24, "Pyromancer", , , { className: "c24", tinyIcon: "classicon_pyromancer" }],
    [25, "Cultist", , , { className: "c25", tinyIcon: "classicon_cultist" }],
    [26, "Starcaller", , , { className: "c26", tinyIcon: "classicon_starcaller" }],
    [27, "Sun Cleric", , , { className: "c27", tinyIcon: "classicon_suncleric" }],
    [28, "Tinker", , , { className: "c28", tinyIcon: "classicon_tinker" }],
    [29, "Venomancer", , , { className: "c29", tinyIcon: "classicon_prophet" }],
    [30, "Reaper", , , { className: "c30", tinyIcon: "classicon_reaper" }],
    [31, "Primalist", , , { className: "c31", tinyIcon: "classicon_wildwalker" }],
    [32, "Runemaster", , , { className: "c32", tinyIcon: "classicon_spiritmage" }],
];
var mn_races = [
...
var mn_items = [
    ...
    [16, "Glyphs", , [
        [6, "Death Knight", , [[1, "Major"], [2, "Minor"]], { className: "c6", tinyIcon: "classicon_deathknight" }],
        [11, "Druid", , [[1, "Major"], [2, "Minor"]], { className: "c11", tinyIcon: "classicon_druid" }],
        [3, "Hunter", , [[1, "Major"], [2, "Minor"]], { className: "c3", tinyIcon: "classicon_hunter" }],
        [8, "Mage", , [[1, "Major"], [2, "Minor"]], { className: "c8", tinyIcon: "classicon_mage" }],
        [2, "Paladin", , [[1, "Major"], [2, "Minor"]], { className: "c2", tinyIcon: "classicon_paladin" }],
        [5, "Priest", , [[1, "Major"], [2, "Minor"]], { className: "c5", tinyIcon: "classicon_priest" }],
        [4, "Rogue", , [[1, "Major"], [2, "Minor"]], { className: "c4", tinyIcon: "classicon_rogue" }],
        [7, "Shaman", , [[1, "Major"], [2, "Minor"]], { className: "c7", tinyIcon: "classicon_shaman" }],
        [9, "Warlock", , [[1, "Major"], [2, "Minor"]], { className: "c9", tinyIcon: "classicon_warlock" }],
        [1, "Warrior", , [[1, "Major"], [2, "Minor"]], { className: "c1", tinyIcon: "classicon_warrior" }]
    ]],
    [7, "Trade Goods", , [
    ...
    [101, "Pet Whistles", , [
        [, "Pet Whistles"],
        [1, "Beastmaster's Whistles"],
        [2, "Blood Soaked Vellums"],
        [3, "Summoner's Stones"],
        [4, "Draconic Warhorns"],
        [5, "Elemental Lodestones"]
    ]],
    [15, "Miscellaneous", , [
        [-2, "Armor Tokens"],
        [3, "Holiday"],
...
var mn_skills = [
    ...
    [732, "Woodcutting", "?skill=732", , { tinyIcon: "inv_throwingaxe_05" }],
...
var mn_spells = [
    ...
    [410, "Season 9 Wildcard", , [
        ...
        [5, "Shattered Spells", ,],
        [6, "Shattered Talents", ,],
    ], { tinyIcon: "inv_misc_dice_01" }],
    [400, "Mystic Enchantments", , [
        [2, "Uncommon", , , { className: "mystic-uncommon" }],
        [3, "Rare", , , { className: "mystic-rare" }],
        [4, "Epic", , , { className: "mystic-epic" }],
        [5, "Legendary", , , { className: "mystic-legendary" }],
        [6, "Worldforged", , , { className: "mystic-worldforged" }]
    ]],
    [-4, "Racial Traits"],
    ...
    [9, "Secondary Skills", , [
        ...
        [732, "Woodcutting", , , { tinyIcon: "inv_throwingaxe_05" }],
...
var mn_pets = [
    ...
    [, "Enslave Demon"],
    [3, "Demons", , , { tinyIcon: "achievement_boss_hellfire_fellord" }],
    [, "Dominate Undead"],
    [4, "Undead", , , { tinyIcon: "ui_darkshore_warfront_horde_abomination" }],
    [, "Tether Elemental"],
    [5, "Elementals", , , { tinyIcon: "inv_pet_pandarenelemental" }],
    [, "Tame Dragonkin"],
    [6, "Dragonkin", , , { tinyIcon: "achievement_boss_onyxia" }],
...
var mn_achievements = [
    ...
    [168, "Dungeons & Raids", , [
        ...
        [15100, "Zul'Gurub"],
        [15109, "Ahn'Qiraj"],
        [15112, "Blackwing Lair"],
        [17000, "Karazhan"],
        [17001, "Gruul's Lair"],
        [17002, "Magtheridon's Lair"],
        [17003, "Serpentshrine Cavern"],
        [17004, "Tempest Keep"],
        [17005, "Zul'Aman"],
        [17006, "Mount Hyjal"],
        [17007, "Black Temple"],
        [17008, "Sunwell Plateau"],
        [17012, "Blackrock Caverns"],
    ]],
    [169, "Professions", , [
        [170, "Cooking"],
        [171, "Fishing"],
    ...
    [12000, "Nightmare Mode", , [
        [12001, "Vanilla Dungeons"],
        [12002, "Vanilla Heroic Dungeons"],
        [12003, "Vanilla Mythic Dungeons"],
        [12004, "Vanilla Raids"],
        [12005, "TBC Mythic Dungeons"],
        [12006, "TBC Raids"],
    ...
    [12010, "Prestige"],
    [16135, "Ascension Seasonal", , [
        [15105, "Former Season Achievements"],
        [16133, "Current Season Achievements"],
    ]],
    [17009, "Collections", , [
        [17010, "Mounts"],
        [17011, "Pets"],
...
var mn_currencies = [
    ...
    [41, "Ascension: Character Advancement", "?currencies=41"],
    [45, "Mystic Enchantments", "?currencies=45"],
    [47, "Scrolls of Fortune", "?currencies=47"],
    [46, "Felforged", "?currencies=46"],
...
var mn_icons = [
    ...
    [9, "Tameable Pets", "?icons&filter=cr=9;crs=1;crv=0"],
...
var mn_builddraft = [
    [, "Build Draft Builds (Lvl 60)"],
    [0, "All Builds", "?builddraft=all", , { tinyIcon: "achievement_bg_most_damage_killingblow_dieleast" }],
    [, "Roles"],
    [1, "Damage", "?builddraft=damage", , { tinyIcon: "inv_sword_27" }],
    [2, "Healing", "?builddraft=heal", , { tinyIcon: "spell_nature_healingtouch" }],
    [3, "Tanking", "?builddraft=tank", , { tinyIcon: "ability_warrior_shieldreflection" }],
...
var mn_database = [
    ...
    [, "Items"],
    [0, "Items", "?items&filter=na=", mn_items],
    [2, "Item Sets", "?itemsets&filter=na=", null], //don't show for class specific ones
    [101, "Enchantments", "?enchantments", mn_enchantments],
    [, "Character"],
    //[400, "Build Draft (Lvl 60)","?builddraft=all", mn_builddraft],
    [9, "Achievements", "?achievements", mn_achievements],
    [12, "Classes", "?classes", mn_classes],
    [100, "Emotes", "?emotes", null],
    [8, "Tameable Pets", "?pets", mn_pets],
    ...
    [11, "World Events (Excluded)", "?events", mn_holidays, { requiredAccess: 1726 }],
    [6, "Zones", "?zones", mn_zones],
    [, "Other"],
    [31, "Icons", "?icons", mn_icons],
    [19, "Sounds", "?sounds", mn_sounds],
    [102, 'Areatrigger (Excluded) ', '?areatriggers', mn_areatrigger, { requiredAccess: 1726 }],
    [103, 'Mails (Excluded) ', '?mails', null, { requiredAccess: 1726 }]
];

var mn_weakauras_professions = [
    [, "Professions"],
    [1, "Alchemy", null, , { tinyIcon: "trade_alchemy" }],
    [2, "Blacksmithing", null, , { tinyIcon: "trade_blacksmithing" }],
    [3, "Enchanting", null, , { tinyIcon: "trade_engraving" }],
    [4, "Engineering", null, , { tinyIcon: "trade_engineering" }],
    [5, "Herbalism", null, , { tinyIcon: "spell_nature_naturetouchgrow" }],
    [6, "Inscription", null, , { tinyIcon: "inv_inscription_tradeskill01" }],
    [7, "Jewelcrafting", null, , { tinyIcon: "inv_misc_gem_01" }],
    [8, "Leatherworking", null, , { tinyIcon: "inv_misc_armorkit_17" }],
    [9, "Mining", null, , { tinyIcon: "trade_mining" }],
    [10, "Skinning", null, , { tinyIcon: "inv_misc_pelt_wolf_01" }],
    [11, "Tailoring", null, , { tinyIcon: "trade_tailoring" }],
    [, "Secondary"],
    [12, "Cooking", null, , { tinyIcon: "inv_misc_food_15" }],
    [13, "First Aid", null, , { tinyIcon: "spell_holy_sealofsacrifice" }],
    [14, "Fishing", null, , { tinyIcon: "trade_fishing" }],
]


var mn_weakauras_coa = [
    [, "Classes"],
    [12, "Barbarian", null, , { className: "c12", tinyIcon: "classicon_barbarian" }],
    [13, "Witch Doctor", null, , { className: "c13", tinyIcon: "classicon_witchdoctor" }],
    [14, "Felsworn", null, , { className: "c14", tinyIcon: "classicon_demonhunter" }],
    [15, "Witch Hunter", null, , { className: "c15", tinyIcon: "classicon_witchhunter" }],
    [16, "Stormbringer", null, , { className: "c16", tinyIcon: "classicon_stormbringer" }],
    [17, "Knight of Xoroth", null, , { className: "c17", tinyIcon: "classicon_fleshwarden" }],
    [18, "Guardian", null, , { className: "c18", tinyIcon: "classicon_guardian" }],
    [19, "Templar", null, , { className: "c19", tinyIcon: "classicon_monk" }],
    [20, "Bloodmage", null, , { className: "c20", tinyIcon: "classicon_sonofarugal" }],
    [21, "Ranger", null, , { className: "c21", tinyIcon: "classicon_ranger" }],
    [22, "Chronomancer", null, , { className: "c22", tinyIcon: "classicon_chronomancer" }],
    [23, "Necromancer", null, , { className: "c23", tinyIcon: "classicon_necromancer" }],
    [24, "Pyromancer", null, , { className: "c24", tinyIcon: "classicon_pyromancer" }],
    [25, "Cultist", null, , { className: "c25", tinyIcon: "classicon_cultist" }],
    [26, "Starcaller", null, , { className: "c26", tinyIcon: "classicon_starcaller" }],
    [27, "Sun Cleric", null, , { className: "c27", tinyIcon: "classicon_suncleric" }],
    [28, "Tinker", null, , { className: "c28", tinyIcon: "classicon_tinker" }],
    [29, "Venomancer", null, , { className: "c29", tinyIcon: "classicon_prophet" }],
    [30, "Reaper", null, , { className: "c30", tinyIcon: "classicon_reaper" }],
    [31, "Primalist", null, , { className: "c31", tinyIcon: "classicon_wildwalker" }],
    [32, "Runemaster", null, , { className: "c32", tinyIcon: "classicon_spiritmage" }],
];

var mn_weakauras_pve = [
    [, "PvE"],
    [1, "Dungeons", null, , { tinyIcon: "_lfg_yellow" }],
    [2, "Mythic Plus", null, , { tinyIcon: "inv_relics_hourglass" }],
    [3, "Raiding", null, , { tinyIcon: "achievement_aq_cthun" }],
    [, "Roles"],
    [4, "Tank", null, , { tinyIcon: "ability_warrior_defensivestance" }],
    [5, "Healer", null, , { tinyIcon: "spell_holy_restoration" }],
    [6, "DPS", null, , { tinyIcon: "ability_marksmanship" }],
]

var mn_weakauras_pvp = [
    [, "PvP"],
    [1, "Arena", null, , { tinyIcon: "ability_pvp_gladiatormedallion" }],
    [2, "Battlegrounds", null, , { tinyIcon: "inv_bannerpvp_03" }],
    [3, "High-Risk", null, , { tinyIcon: "warrior_skullbanner" }],
]


var mn_leaderboards = [
    [, "Trials (League 4)"],
    [1, 'Trials', '?leaderboard=trials', null, { tinyIcon: 'achievement_bg_killflagcarriers_grabflag_capit' }],
    [2, 'Trial Completions', '?leaderboard=trial-completions', null, { tinyIcon: 'achievement_bg_grab_cap_flagunderxseconds' }],
];


var mn_weakauras = [
    [, "User"],
    [10, 'Submit WeakAura', '?weakauras=share'],
    [11, 'My WeakAuras', '?weakauras=user'],
    [, "WeakAuras"],
    [1, 'All', '?weakauras=1'],
    [2, 'Recently Added', '?weakauras=2'],
    [3, 'Popular', '?weakauras=3'],
    [, "Categories"],
    [100, "Mystic Enchantments", '?weakauras=100', null, { tinyIcon: wa_categories_icons[1] }],
    [120, "PvE", '?weakauras=120', mn_weakauras_pve, { tinyIcon: wa_categories_icons[2] }],
    [130, "PvP", '?weakauras=130', mn_weakauras_pvp, { tinyIcon: wa_categories_icons[3] }],
    [140, "Professions", '?weakauras=140', mn_weakauras_professions, { tinyIcon: wa_categories_icons[4] }],
    [150, "Miscellaneous", '?weakauras=150', null, { tinyIcon: wa_categories_icons[5] }],
    // [160, "Build Draft", '?weakauras=160',null, {tinyIcon: wa_categories_icons[7]}],
    [200, "Conquest of Azeroth", "?weakauras=200", null, { tinyIcon: wa_categories_icons[6] }],
...
var mn_tools = [
    ...
    [, "Tools"],
    [11, "Mystic Enchant Designer", , [
        [1, "Create Mystic Enchant", "?mystic-enchant-creator", null, { tinyIcon: "inv_misc_orb_purple" }],
        [2, "My Mystic Enchants", "?my-mystic-enchants", null, { tinyIcon: '_scroll1_violet' }]
    ], { tinyIcon: "ability_racial_arcaneaffinity" }],
    [3, "Item Comparison", "?compare", null, { tinyIcon: "inv_chest_chain_03", }],
    [1, "Mapper", "?maps", null, { tinyIcon: "icon_treasuremap" }],
    [0, "Build Calculator", "https://ascension.gg/v2/builder/area-52/", null, { tinyIcon: "ascension_logo", newWindow: true }],
    [, "Other"],
    [14, "Maintenance Schedule", "?update-schedule", null, { tinyIcon: "spell_mekkatorque_bot_redwrench" }],
];
var mn_reputation = [
...
var mn_community = [
    [, "Links"],
    [3, "Official Website", "https://ascension.gg", null, { tinyIcon: "ascension_logo", newWindow: true }],
    [4, "Ascension Wiki", "https://project-ascension.fandom.com/wiki/Project_Ascension_Wiki", null, { tinyIcon: "ascension_logo" }],
    [, "Reputation"],
...
var mn_statistics = [
    [, "Statistics"],
    [1, "PvE - Area 52", "?statistics=area52", null, { tinyIcon: "ascension_logo" }],
    // [2, "More Coming Soon~", "", null, { tinyIcon: "ascension_logo" }],
];

var mn_guides = [
    [, "User"],
    [0, "Create New Guide", '?guide=new', null,],
    [0, "My Guides", '?my-guides', null,],
    [, "Guides"],
    [0, "All", '?guides', null,],
    [, "Categories"],
    [1, "New Players & Leveling", '?guides=1', null, { tinyIcon: l_guide_categories_icons[1] }],
    [2, "Raid & Boss Fights", '?guides=2', null, { tinyIcon: l_guide_categories_icons[2] }],
    [4, "Builds", '?guides=4', null, { tinyIcon: l_guide_categories_icons[4] }],
    [5, "Achievements", '?guides=5', null, { tinyIcon: l_guide_categories_icons[5] }],
    [6, "Gold & Economy", '?guides=6', null, { tinyIcon: l_guide_categories_icons[6] }],
    [9, "Trials & Challenges", '?guides=8', null, { tinyIcon: l_guide_categories_icons[8] }],
    [7, "High-Risk", '?guides=7', null, { tinyIcon: l_guide_categories_icons[7] }],
    [3, "Miscellaneous", '?guides=3', null, { tinyIcon: l_guide_categories_icons[3] }],
...
var mn_path = [
    ...
    //    [11, "Leaderboards",  null, mn_leaderboards],
    [10, "WeakAuras", null, mn_weakauras],
    [12, "Guides", null, mn_guides],
    [13, "Stats", null, mn_statistics],
...
var g_wa_categories = {
    100: 'Mystic Enchantments',
    120: 'PvE',
    130: 'PvP',
    140: 'Professions',
    150: 'Miscellaneous',
    // 160: 'Build Draft',
    200: 'Conquest of Azeroth',
};

var g_wa_subcategories = {
    // 11: {
    //     12: 'Barbarian',
    //     13: 'Witch Doctor',
    //     14: 'Demon Hunter',
...
var g_exclusion_types = {
    1: 'SYSTEM',
    2: 'USER',
}

var g_exclusion_states = {
    0: 'INCLUDED (override)',
    1: 'EXCLUDED',
}
...
var g_item_difficulty = {
    ...
    6: 'Ascended Raid',
    7: 'Bloodforged',
    8: 'Heroic Bloodforged',
    50: 'Ascended', //placeholder - unused.
};
...
var g_quest_sorts = {
    ...
    "-377": 'Tutorial',
    "-378": 'Profession',
    "-379": 'Ascension Main Quest',
    "-380": 'Ascension (PvE)',
    "-381": 'Ascension (PvP)',
    "-382": 'Ascension (Profession)',
    1: 'Dun Morogh',
    3: 'Badlands',
    4: 'Blasted Lands',
    8: 'Swamp of Sorrows',
    ...
    4987: 'The Ruby Sanctum',
    11211: 'Ascension' //dbc_area_table (AreaTable.dbc)
};
...
var g_spell_skills = {
    ...
    //END COA CLASSES
    120: 'Ascension Vanity Items',
    121: 'Mystic Enchanting',
    6: 'Mage', //Frost
    8: 'Fire',
    26: 'Warrior', // Arms
    38: 'Rogue', //Combat
    ...
    // 51: 'Survival', - Replaced with Witch Doctor Shadowhunting?
    54: 'Maces',
    55: 'Two-Handed Swords',
    56: 'Priest', // Holy
    // 78: 'Shadow Magic', - Replaced with Ranger Survival?
    95: 'Defense',
    98: 'Language: Common',
    101: 'Racial - Dwarven',
    109: 'Language: Orcish',
    ...
    //Custom Tameables about 157 of them.
    1: 'Pit Lord',
    2: 'Darkhound',
    3: 'Doomguard',
    4: 'Fel Beast',
    ...
    807: 'Skeletal Mage',
    808: 'Alemental',
    809: 'Pandaren Water Spirit',
    810: 'Pandaren Fire Spirit',
    811: 'Pandaren Earth Spirit',
    812: 'Pandaren Air Spirit',
    813: 'Primal Ascendant',
    814: 'Quicksilver Ascendant',
    815: 'Ice Ascendant',
    816: 'Water Ascendant',
    817: 'Fire Ascendant',
    818: 'Earth Ascendant',
    ...
    826: 'Air Revenant',
    827: 'Flux Elemental',
    828: 'Arcane Elemental',
    829: 'Steam Elemental',
    830: 'Unbound Lightning Elemental',
    831: 'Unbound Water Elemental',
    832: 'Unbound Fire Elemental',
    833: 'Azerite Elemental',
    834: 'Unbound Earth Elemental',
    835: 'Unbound Air Elemental',
    836: 'Bound Water Elemental',
    837: 'Bound Fire Elemental',
    838: 'Bound Earth Elemental',
    839: 'Bound Air Elemental',
    840: 'Light Elemental',
    841: 'Shadow Elemental',
    842: 'Mojo Elemental',
    843: 'Entropic Elemental',
    844: 'Mana Elemental',
    845: 'Sand Elemental',
    846: 'Ice Elemental',
    847: 'Magma Elemental',
    ...
    869: 'Black Scalebane        ',
    870: 'Black Wyrmkin          ',
    871: 'Black Flametongue      ',
    872: 'Black Drakeadon        ',
    873: 'Black Dragonman        ',
    874: 'Black Dracthyr         ',
    875: 'Blue Proto-dragon      ',
    876: 'Blue Whelp             ',
    877: 'Blue Drake             ',
    878: 'Blue Dragon            ',
    879: 'Blue Aspect            ',
    ...
    881: 'Blue Scalebane         ',
    882: 'Blue Wyrmkin           ',
    883: 'Blue Flametongue       ',
    884: 'Blue Drakeadon         ',
    885: 'Blue Dragonman         ',
    886: 'Blue Dracthyr          ',
    887: 'Bronze Proto-dragon    ',
    888: 'Bronze Whelp           ',
    889: 'Bronze Drake           ',
    890: 'Bronze Dragon          ',
    891: 'Bronze Aspect          ',
    892: 'Bronze Drakonid        ',
    893: 'Bronze Scalebane       ',
    894: 'Bronze Wyrmkin         ',
    895: 'Bronze Flametongue     ',
    896: 'Bronze Drakeadon       ',
    897: 'Bronze Dragonman       ',
    898: 'Bronze Dracthyr        ',
    899: 'Green Proto-dragon     ',
    900: 'Green Whelp            ',
    901: 'Green Drake            ',
    902: 'Green Dragon           ',
    903: 'Green Aspect           ',
    ...
    905: 'Green Scalebane        ',
    906: 'Green Wyrmkin          ',
    907: 'Green Flametongue      ',
    908: 'Green Drakeadon        ',
    909: 'Green Dragonman        ',
    910: 'Green Dracthyr         ',
    911: 'Red Proto-dragon       ',
    912: 'Red Whelp              ',
    913: 'Red Drake              ',
    914: 'Red Dragon             ',
    915: 'Red Aspect             ',
    ...
    921: 'Red Dragonman          ',
    922: 'Red Dracthyr           ',
    923: 'Chromatic Proto-dragon ',
    924: 'Chromatic Whelp        ',
    925: 'Chromatic Drake        ',
    926: 'Chromatic Dragon       ',
    927: 'Chromatic Aspect       ',
    928: 'Chromatic Drakonid     ',
    929: 'Chromatic Scalebane    ',
    930: 'Chromatic Wyrmkin      ',
    931: 'Chromatic Flametongue  ',
    932: 'Chromatic Drakeadon    ',
    933: 'Chromatic Dragonman    ',
    934: 'Chromatic Dracthyr     ',
    935: 'Infinite Proto-dragon  ',
    936: 'Infinite Whelp         ',
    937: 'Infinite Drake         ',
    938: 'Infinite Dragon        ',
    939: 'Infinite Aspect        ',
    940: 'Infinite Drakonid      ',
    941: 'Infinite Scalebane     ',
    942: 'Infinite Wyrmkin       ',
    943: 'Infinite Flametongue   ',
    944: 'Infinite Drakeadon     ',
    945: 'Infinite Dragonman     ',
    946: 'Infinite Dracthyr      ',
    947: 'Twilight Proto-dragon  ',
    948: 'Twilight Whelp         ',
    949: 'Twilight Drake         ',
    950: 'Twilight Dragon        ',
    951: 'Twilight Aspect        ',
    952: 'Twilight Drakonid      ',
    953: 'Twilight Scalebane     ',
    954: 'Twilight Wyrmkin       ',
    955: 'Twilight Flametongue   ',
    956: 'Twilight Drakeadon     ',
    957: 'Twilight Dragonman     ',
    958: 'Twilight Dracthyr      ',
    959: 'Netherwing Proto-dragon',
    960: 'Netherwing Whelp       ',
    961: 'Netherwing Drake       ',
    962: 'Netherwing Dragon      ',
    963: 'Netherwing Aspect      ',
    964: 'Netherwing Drakonid    ',
    965: 'Netherwing Scalebane   ',
    966: 'Netherwing Wyrmkin     ',
    967: 'Netherwing Flametongue ',
    968: 'Netherwing Drakeadon   ',
    969: 'Netherwing Dragonman   ',
    970: 'Netherwing Dracthyr    ',
    971: 'Plagued Proto-dragon   ',
    972: 'Plagued Whelp          ',
    973: 'Plagued Drake          ',
    974: 'Plagued Dragon         ',
    975: 'Plagued Aspect         ',
    976: 'Plagued Drakonid       ',
    977: 'Plagued Scalebane      ',
    978: 'Plagued Wyrmkin        ',
    979: 'Plagued Flametongue    ',
    980: 'Plagued Drakeadon      ',
    981: 'Plagued Dragonman      ',
    982: 'Plagued Dracthyr       ',
    983: 'Storm Proto-dragon     ',
    984: 'Storm Whelp            ',
    985: 'Storm Drake            ',
    986: 'Storm Dragon           ',
    987: 'Storm Aspect           ',
    ...
    1008: 'Lasher',
    1009: 'Golem',
    1010: 'Constrictor Orchid',
    1011: 'Constrictor Lasher',
    1012: 'Mutated Orchid',
    1013: 'Mutated Lasher',
    1014: 'Bloodpetal Orchid',
    1015: 'Bloodpetal Lasher',
    1016: 'Frostpetal Orchid',
    1017: 'Frostpetal Lasher',
    1018: 'Deathpetal Orchid',
    1019: 'Deathpetal Lasher',
    1020: 'Stone War Golem',
    1021: 'Stone Siege Golem',
    1022: 'Dark Iron War Golem',
    1023: 'Dark Iron Siege Golem',
    1024: 'Ragereaver War Golem',
    1025: 'Ragereaver Siege Golem',
    1026: 'Molten War Golem',
    1027: 'Molten Siege Golem',
    1028: 'Iron War Golem',
    1029: 'Iron Siege Golem',
    1030: 'Drakkari War Golem',
    1031: 'Drakkari Siege Golem',
    1032: 'Runic War Golem',
    1033: 'Runic Siege Golem',
    1034: 'Verdant Bog Beast',
    1035: 'Fungal Bog Beast',
    11791: 'Faceless Servant',
...
var g_zones = {
    ...
    7107: 'Southshore vs. Tarren Mill',
    3817: 'Testing Area',
};
...
var g_achievement_categories = {
    ...
    12010: 'Prestige',
    15074: "Twin Peaks",
    15087: "Raid Boss Kills",
    15064: "Ring of Valor",
    15065: "Hyjal",
    15066: "Aszhara Crater",
    15093: "Zul'Gurub",
    15094: "Molten Core",
    15095: "Death to Bosses",
    15096: "Zul'Gurub",
    15097: "Molten Core",
    15099: "Molten Core",
    15100: "Zul'Gurub",
    15103: "Ascension Season 1",
    15105: "Former Season Achievements",
    15107: "Ahn'Qiraj",
    15108: "Ahn'Qiraj",
    15109: "Ahn'Qiraj",
    15110: "Blackwing Lair",
    15111: "Blackwing Lair",
    15112: "Blackwing Lair",
    15114: "Ascension Season 2",
    15124: "Ascension Season 3",
    15129: "Ascension Season 3",
    15130: "Ascension Season 3",
    15132: "Ascension",
    15134: "Ascension Season 4",
    15139: "Ascension Season 4",
    15140: "Ascension Season 4",
    16124: "Ascension Season 5",
    16129: "Ascension Season 5",
    16130: "Ascension Season 5",
    16133: "Current Achievement Rewards",
    16135: "Ascension Seasonal",
    17000: "Karazhan",
    17001: "Gruul's Lair",
    17002: "Magtheridon's Lair",
    17003: "Serpentshine Caverns",
    17004: "Tempest Keep",
    17005: "Zul'Aman",
    17006: "Mount Hyjal",
    17007: "Black Temple",
...
var g_currency_categories = {
    ...
    22: 'Dungeon and Raid',
    23: 'Burning Crusade',
    41: 'Ascension: Character Advancement',
    42: 'Scrolls of Fortune',
    43: 'Ascension: Miscellaneous',
    45: 'Mystic Enchantments',
    46: 'Felforged',
    47: 'Scrolls of Fortune'
...
var LANG = {
    ...
    coaclasses: "Conquest of Azeroth Classes",
    tab_coaclasses: "CoA Classes",
    classs: "Class",
    close: "Close",
    completed: "Completed",
    ...
    tooltip_reqmythic: "Mythic Level",
    ...
    tab_mysticenchantents: "Mystic Enchantments",
    tab_mysticenchantscrolls: "Scrolls",
    tab_tameitems: "Pet Whistles",
    ...
    tab_mounts: "Mounts",
    //CUSTOM ASCENSION
    tab_ascension_normal: "Normal",
    tab_ascension_heroic: "Heroic",
    tab_ascension_mythic: "Mythic",
    tab_ascension_ascended: "Ascended",
    tab_normaldrops: "Normal drops",
    tab_normalXdrops: "Normal $1 drops",
    tab_normal: "Normal",
    tab_normalX: "Heroic $1",
    tab_noteworthy: "Noteworthy",
    tab_npcs: "NPCs",
    tab_npcabilities: "NPC abilities",
    tab_objectiveof: "Objective of",
    tab_objects: "Objects",
    tab_pets: "Tameable Pets",
    ...
    tab_samemodelas: "Same model as (no preview)",
    ...
    tab_unlocks: "Unlocks",
    tab_usedby: "Used by",
    tab_re_effects: "Spells & Effects",
    tab_re_requires: "Requirements",
    tab_ascension_teaches: "Teaches Spells",
    tab_ascension_options: "Mastery Spells",
    tab_videos: "Videos",
    ...
    ct_dialog_contactwowhead: "Feedback, Issues and Reports",
    ...
    compose_formattinghelp: "Formatting Guide <i class=\"fa-regular fa-circle-question\"></i> ",
    compose_save: "Save",
    ...
    types: {
        ...
        //         public const MYSTICENCHANTS =             369;
        //     public const WEAKAURA =                   370;
        370: ["WeakAura", "WeakAura", "WeakAuras", "weakauras"],
        372: ["Build", "Build", "Builddraft", "builddraft"],
    ...
    fiitems: {
        ...
        heroicitem: "Heroic",
        mythicitem: "Mythic",
        mythicplusitem: "Mythic Plus",
        mythicraiditem: "Mythic Raid",
        heroicraiditem: "Heroic Raid",
        ascendeditem: "Ascended Raid",
        bloodforgeditem: "Bloodforged",
        heroicbloodforgeditem: "Heroic Bloodforged",
        icon: "Icon",
        id: "ID",
        locked: "Locked",
        millable: "Millable",
    ...
    fispells: {
        ...
        mys: "Mystic Enchant Rarity",
        myscommon: "Common",
        mysuncommon: "Uncommon",
        mysrare: "Rare",
        mysepic: "Epic",
        myslegendary: "Legendary",
        mysworldforged: "Worldforged",
        ...
        cooldownDuration: "Cooldown (seconds)",
        rankText: "Rank text",
    ...
    guideAuthor: 'Author',
    autoresizetextbox: 'Auto-Resize',

    restock: 'Restock',

    descriptionlengthlong_tip: 'Your description is $1 too long! It will most likely be truncated.',
